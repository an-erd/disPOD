...
static int mount_sd_card()
{
    ...
    slot_config.gpio_miso = (gpio_num_t) CONFIG_SDCARD_PIN_MISO;
    slot_config.gpio_mosi = (gpio_num_t) CONFIG_SDCARD_PIN_MOSI;
    slot_config.gpio_sck  = (gpio_num_t) CONFIG_SDCARD_PIN_CLK;
    slot_config.gpio_cs   = (gpio_num_t) CONFIG_SDCARD_PIN_CS;
